...
;
[Setup]
AppID={{e810503d-9028-4569-9158-0f9d042e00cf}
...
[Files]
Source: "E:\Visual Studio\Project files\Gizmo\FlatMaestro\bin\Release\ASCOM.FlatMaestro.exe"; DestDir: "{app}"
...
Filename: "{app}\ASCOM.FlatMaestro.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.FlatMaestro.exe"; Parameters: "/unregister"
[InstallDelete]
Type: files; Name: "C:\Program Files (x86)\Common Files\ASCOM\CoverCalibrator\ASCOM.FlatMaestro.exe"
