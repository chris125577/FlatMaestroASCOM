// ASCOM CoverCalibrator driver for FlatMaestro
//
// Description:	 <ASCOM driver for Arduino FlatMaster project>
//
...
namespace ASCOM.FlatMaestro.CoverCalibrator
{
    ...
    //
    // Your driver's DeviceID is ASCOM.FlatMaestro.CoverCalibrator
    //
    // The COM Guid attribute sets the CLSID for ASCOM.FlatMaestro.CoverCalibrator
    // The COM ClassInterface/None attribute prevents an empty interface called _FlatMaestro from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("f2fb31be-3caa-4624-8624-72ca69384f97")]
    [ProgId("ASCOM.FlatMaestro.CoverCalibrator")]
    [ServedClassName("FlatMaestro")] // Driver description that appears in the Chooser, customise as required
    ...
    public class CoverCalibrator : ReferenceCountedObjectBase, ICoverCalibratorV1, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlatMaestro"/> class. Must be public to successfully register for COM.
        /// </summary>
        public CoverCalibrator()
        {
            try
            {
                ...
                tl = new TraceLogger("", "FlatMaestro.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
