...
;
[Setup]
AppID={{e879f84b-0516-4b5d-8f82-d0c37d0e610c}
AppName=ASCOM FlatMaestro CoverCalibrator Driver
AppVerName=ASCOM FlatMaestro CoverCalibrator Driver 1.1
AppVersion=1.1
...
OutputDir="."
OutputBaseFilename="FlatMaestro Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\CoverCalibrator\FlatMaestro"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\CoverCalibrator\FlatMaestro"
...
Root: HKCR; Subkey: AppId\{#AppClsid}; ValueType: string; ValueData: "ASCOM FlatMaestro CoverCalibrator Driver"
...
begin
   ...
   P.Register('FlatMaestro.CoverCalibrator', 'Flat Maestro');
end;
...
begin
   ...
   begin
     P := CreateOleObject('ASCOM.Utilities.Profile');
     P.DeviceType := 'CoverCalibrator';
     P.Unregister('FlatMaestro.CoverCalibrator');
  end;
end;
