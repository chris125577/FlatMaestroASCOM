...
;
[Setup]
AppID={{6c81af44-d355-4481-807c-b08df5998c5b}
AppName=ASCOM Flat Maestro CoverCalibrator Driver
AppVerName=ASCOM Flat Maestro CoverCalibrator Driver 1.1
AppVersion=1.1
...
OutputDir="."
OutputBaseFilename="Flat Maestro Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\CoverCalibrator\Flat Maestro"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\CoverCalibrator\Flat Maestro"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "E:\Visual Studio\Project files\Gizmo\FlatMaestro\ASCOM.FlatMaestro.exe"; DestDir: "{app}" ;AfterInstall: RegASCOM()
...
Root: HKCR; Subkey: AppId\{#AppClsid}; ValueType: string; ValueData: "ASCOM Flat Maestro CoverCalibrator Driver"
...
begin
   ...
   P.Register('Flat Maestro.CoverCalibrator', 'Flat Maestro');
end;
...
begin
   ...
   begin
     P := CreateOleObject('ASCOM.Utilities.Profile');
     P.DeviceType := 'CoverCalibrator';
     P.Unregister('Flat Maestro.CoverCalibrator');
  end;
end;
